                ...
                <div class="collapse navbar-collapse Barra" id="#bs-example-navbar-collapse-2">
                  <ul class="nav navbar-nav">
                    ...
                    <!-- <li class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="secciones">Listados</a></li>
...
<br>
<br>
Pero me causo curiosidad que no escuche en estos países de Norte América, Europa y Norte de Africa, los ritmos que identifican la alegría y la afabilidad de los colombianos que a través de nuestra música irradiamos identidad y alegría para el mundo.
<br>
<br>
Entonces me propuse crear una estación radial virtual que colmara las expectativas de un gran número de personas  como yo, que quieren escuchar no solo un género específico, sino las grandes alternativas que nos ofrece el fantástico mundo de la música sin importar su origen ni el lugar del mundo donde te encuentres.
<br>
<br>
Hoy coloco a su entera disposición La Emisora VIRTUAL STEREO NET, seguramente será su más fiel compañía en sus ratos de alegría o de grandes sentimientos, acompañado con sus amigos o en los momentos de nostalgia, porque somos la mejor alternativa en la Red.
<br>
<br>
...
Director.</a>
  ...
  <button type="button" onclick="sendEmail()">Enviar</button>	</div>
        ...
        <script src="<?php echo URL; ?>Views/Templates/js/utilidades.js">
        </script>
        <script>
        new WOW().init();
        </script>
